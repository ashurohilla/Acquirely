          ...
          <div className="mx-auto mt-12 grid max-w-[1128px] gap-5 lg:grid-cols-2">
            <div className="rounded-[14px] border border-[#065F46] bg-[#F1FBF8] p-6 sm:p-[33px]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[12px] font-semibold uppercase tracking-[0.6px] text-[#059669]">
            ...
            <div className="rounded-[14px] border border-[#F87171] bg-[#FEF5F5] p-6 sm:p-[33px]">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-[20px] font-bold leading-7 text-black">Not For You</h3>
                  <p className="text-[12px] font-semibold uppercase tracking-[0.6px] text-[#F87171]">
                    Please don't apply
                  </p>
                </div>
              </div>
              ...
              <div className="mt-10 inline-flex min-h-[50px] w-full items-center justify-center gap-2 rounded-[6px] border border-[#94A3B8] px-4 text-center text-[14px] font-semibold text-[#94A3B8]">
